<?php
/*
Plugin Name: PLUGIN TEST SEXO
Description: PLUGIN TEST SEXO
Version: 1.0
Author: Psycholoopgy
*/
...
register_activation_hook(__FILE__, function () {
    global $wpdb;
    $tabla_resultados = $wpdb->wp_fp6zg . 'sexo_resultados';
    $tabla_respuestas = $wpdb->wp_fp6zg . 'sexo_respuestas';
...
add_shortcode('sexo', function () {
    ...
    <div class="psicotest-container">
        <h2>Test de Adicción al Sexo</h2>
        <form method="POST">
