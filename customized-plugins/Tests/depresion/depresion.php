<?php
/*
Plugin Name: PLUGIN TEST DEPRESIÓN
Description: PLUGIN TEST DEPRESIÓN
Version: 1.0
Author: Psycholoopgy
*/
...
register_activation_hook(__FILE__, function () {
    global $wpdb;
    $tabla_resultados = $wpdb->prefix . 'depresion_resultados';
    $tabla_respuestas = $wpdb->prefix . 'depresion_respuestas';
...
add_shortcode('depresion', function () {
